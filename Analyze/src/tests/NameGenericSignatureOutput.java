...
public class NameGenericSignatureOutput {
	    ...
	    public void EmptySignature() {
	        ...
	        String request = "map()<Type:G>->sometype";
	    ...
	    public void EmptyGeneric() {
	        AnalyzeRequest.clean();
	        String request = "map(War:Type)<>->sometype";
	        JSONObject actual = AnalyzeRequest.analyze(request);
	        JSONObject expected = new JSONObject();
	        expected.put("error", "parse error");
	        assertEquals(expected, actual);
	    ...
	    public void wrongSignatureVar() {
	        AnalyzeRequest.clean();
	        String request = "map(War:Type)<Type:G>->sometype";
	        JSONObject actual = AnalyzeRequest.analyze(request);
	        JSONObject expected = new JSONObject();
	        expected.put("error", "parse error");
	        assertEquals(expected, actual);
	    ...
	    public void wrongLifetime() {
	        AnalyzeRequest.clean();
	        String request = "map(q:Type3)<''a, 'b,Type1: G1 + G2+G3, Type2: G2+ G4+G5>->sometype";
	        JSONObject actual = AnalyzeRequest.analyze(request);
	        JSONObject expected = new JSONObject();
	        expected.put("error", "parse error");
	        assertEquals(expected, actual);
